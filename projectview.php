        ...
        <nav class="navclass">
            <ul>
                ...
                <li class="view"><a href="#"><b>View </b>
                    ...
                    <li><a href="#"><b>Employee Information</b></a></li>
                    </ul>
                    </a></li>
...
<center><h1 style="margin-bottom:70px; height:40px;width:420px;background-color:yellow;border-radius:10px;">Employee Information View</h1> </center>
<center>
<?php
...
if ($result->num_rows > 0) {
    echo "<table><tr><th>Name</th><th>Id</th><th>Contact</th><th>Action</th></tr>";
   ...
   echo"<td><a href=projectd.php?name=".$row['name'].">Delete/</a>       <a href='oprt.php'>Update</a> /<batton><a href='print3.php'>print</a></td></batton>";
   //echo"<td></td>";
   //echo"<td></td>";
...
?>
<br><br><br><br><br>
   <center><button><a href='printall3.php'>Print</a></button></center>
</center>
